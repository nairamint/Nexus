...
import type { RegulatoryRiskLevel } from '../agents/types.js';
/**
...
export type RegulationType = 'PRIMARY_REGULATION' | 'DELEGATED_REGULATION' | 'TECHNICAL_STANDARD' | 'GUIDELINE' | 'QA_INTERPRETATION' | 'PRECEDENT';
/**
...
export type RuleType = 'CLASSIFICATION_RULE' | 'DISCLOSURE_RULE' | 'CALCULATION_RULE' | 'VALIDATION_RULE' | 'REPORTING_RULE';
...
export type LogicalOperator = 'AND' | 'OR' | 'NOT' | 'IF_THEN' | 'IF_THEN_ELSE' | 'EXISTS' | 'FOR_ALL';
...
export type OperandType = 'LITERAL' | 'VARIABLE' | 'FUNCTION' | 'REFERENCE' | 'CALCULATION';
export type RequiredAction = 'CLASSIFY_AS' | 'REQUIRE_DISCLOSURE' | 'CALCULATE_METRIC' | 'VALIDATE_DATA' | 'GENERATE_REPORT' | 'ESCALATE_REVIEW';
...
export type ComplianceSeverity = 'MANDATORY' | 'RECOMMENDED' | 'OPTIONAL' | 'CONDITIONAL';
...
export type EvidenceType = 'DOCUMENTATION' | 'DATA_POINT' | 'CALCULATION' | 'THIRD_PARTY_VERIFICATION' | 'INTERNAL_ASSESSMENT' | 'EXTERNAL_AUDIT';
/**
...
export type InterpretationType = 'OFFICIAL_GUIDANCE' | 'REGULATORY_PRECEDENT' | 'INDUSTRY_PRACTICE' | 'LEGAL_OPINION' | 'EXPERT_INTERPRETATION' | 'AI_INFERENCE';
...
export type AuthorityLevel = 'REGULATORY_AUTHORITY' | 'INDUSTRY_ASSOCIATION' | 'LEGAL_EXPERT' | 'MARKET_PRACTICE' | 'AI_GENERATED';
/**
...
export type CaseType = 'REGULATORY_DECISION' | 'ENFORCEMENT_ACTION' | 'GUIDANCE_CLARIFICATION' | 'INDUSTRY_CONSULTATION' | 'COURT_DECISION';
...
export type ImplicationType = 'CLASSIFICATION_GUIDANCE' | 'DISCLOSURE_REQUIREMENT' | 'CALCULATION_METHOD' | 'VALIDATION_APPROACH' | 'ENFORCEMENT_RISK';
export type PrecedentValue = 'BINDING' | 'PERSUASIVE' | 'INFORMATIVE' | 'SUPERSEDED';
/**
...
export type ChangeType = 'NEW_REGULATION' | 'AMENDMENT' | 'CLARIFICATION' | 'INTERPRETATION_UPDATE' | 'TECHNICAL_CORRECTION' | 'REVOCATION';
...
export type CostRange = 'MINIMAL' | 'LOW' | 'MEDIUM' | 'HIGH' | 'VERY_HIGH';
export type ChangeStatus = 'PROPOSED' | 'CONSULTATION' | 'APPROVED' | 'EFFECTIVE' | 'SUPERSEDED';
...
export type ConflictType = 'INTERPRETATION_DISAGREEMENT' | 'REGULATORY_AMBIGUITY' | 'CROSS_JURISDICTIONAL' | 'TEMPORAL_INCONSISTENCY' | 'SCOPE_OVERLAP';
export type ResolutionStatus = 'IDENTIFIED' | 'UNDER_REVIEW' | 'ESCALATED' | 'RESOLVED' | 'ACCEPTED_AMBIGUITY';
...
export type ResolutionApproach = 'AUTHORITY_CLARIFICATION' | 'INDUSTRY_CONSENSUS' | 'CONSERVATIVE_INTERPRETATION' | 'RISK_BASED_APPROACH' | 'CASE_BY_CASE_ASSESSMENT';
...
export type NodeStatus = 'ACTIVE' | 'DEPRECATED' | 'SUPERSEDED' | 'UNDER_REVIEW' | 'DRAFT';
...
export type RelationshipType = 'DEPENDS_ON' | 'CONFLICTS_WITH' | 'CLARIFIES' | 'SUPERSEDES' | 'REFERENCES' | 'IMPLEMENTS';
