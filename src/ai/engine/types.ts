 ...
 */
export class ClassificationMetrics implements IClassificationMetrics {
  /** Performance metrics */
  totalClassifications: number = 0;
  successfulClassifications: number = 0;
  averageProcessingTime: number = 0;
  averageConfidence: number = 0;
  errorCount: number = 0;
  ...
  article6Count: number = 0;
  article8Count: number = 0;
